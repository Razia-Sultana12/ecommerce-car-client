...
const ManageAllOrders = () => {
    ...
    return (
        <div>
           ...
           <Container>
        <Typography variant='h4' color='info.main' textAlign='center' my='15px'>Manage All Orders</Typography>
        <Typography variant='h6' textAlign='center'>Total Order placed {orders.length}</Typography>
